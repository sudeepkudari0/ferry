...
import com.mobilerun.portal.input.MobilerunKeyboardEngine.KeyboardEvent
...
class MobilerunKeyboardIME : InputMethodService() {
    ...
    override fun onCreateInputView(): View {
        ...
        val view = layoutInflater.inflate(MockR.layout.keyboard_view, null)
        view.findViewById<Button>(MockR.id.switch_keyboard_button)?.setOnClickListener {
    ...
    private fun openInputMethodSettings() {
        try {
            ...
            Toast.makeText(this, MockR.string.keyboard_switch_settings_help, Toast.LENGTH_LONG).show()
        } catch (e: Exception) {
            Log.e(TAG, "Error opening keyboard settings", e)
            Toast.makeText(this, MockR.string.keyboard_switch_unavailable, Toast.LENGTH_SHORT).show()
        }
    }
}
